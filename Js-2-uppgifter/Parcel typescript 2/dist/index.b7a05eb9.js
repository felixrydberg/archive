...
function numberToString(array1) {
    let data = [];
    for (let key of array1)data.push(key.toString());
    return data;
}
...
function higherOrder(func, array1, array2) {
    if (array1.length === array2.length) {
        let data = [];
        for (let key of array1)data.push(func(key, array2[key - 1]));
        return data;
    }
}
function addCallback(number1, number2) {
    return number1 + number2;
}
function multiplyCallback(number1, number2) {
    return number1 * number2;
}
